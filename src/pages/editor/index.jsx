...
//     axios
//       .post("http://localhost:3500/api/blogs", formData)
...
//           // Image: { uploadCallback: uploadImageCallback, alt: { present: true, mandatory } }
//         }}
//       />
//     </div>
//   );
...
//   const [category, setCategory] = useState(""); // Blog post category
//   const [tags, setTags] = useState(""); // Blog post tags
//   const [image, setImage] = useState(null); // Blog post image
//   const [loading, setLoading] = useState(false);
...
// In your handlePublish function
// const handlePublish = async (e) => {
//   e.preventDefault();
//   setLoading(true);
    ...
    <div className="blog__container">
      ...
      <div className="custom__width editor__width">
        <div className="display__col">
          ...
          {/* <input
            type="text"
            placeholder="Category eg 'entertainment', 'sport', 'future', 'culture', 'lifestyle', 'growth', 'finance', 'health', 'technology'"
            value={category}
            className="input__style"
            onChange={(e) => setCategory(e.target.value)}
          /> */}
