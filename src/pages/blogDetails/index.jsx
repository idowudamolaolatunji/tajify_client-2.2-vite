...
const BlogDetails = () => {
    ...
    async function fetchCurrPost() {
      try {
        const res = await fetch(
          `https://api.tajify.com/api/blogs/${post._id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  useEffect(() => {
    async function fetchCreator() {
      try {
        const res = await fetch(
          `https://api.tajify.com/api/users/${post.creator._id}`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
  ...
  async function handleFollow() {
    try {
      handleReset();
      const res = await fetch(
        `https://api.tajify.com/api/users/${post.creator._id}/request-follow`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  async function handleCancelFollow() {
    try {
      handleReset();
      const res = await fetch(
        `https://api.tajify.com/api/users/${post.creator._id}/cancle-follow-request`,
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
  ...
  */
  ...
  const toggleLike = async () => {
    ...
    try {
      if (liked) {
        const res = await fetch(
          `https://api.tajify.com/api/blogs/unlike-post/${post._id}`,
          {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json",
        ...
        const res = await fetch(
          `https://api.tajify.com/api/blogs/like-post/${post._id}`,
          {
            method: "PATCH",
            headers: {
              "Content-Type": "application/json",
  ...
  const referralUrlWithWWW = post.creator?.referralUrl
    ? `www.tajify.com/${post.creator.referralUrl}`
    : "";
  function copyInput() {
  ...
  return (
    <>
      ...
      <Alert
        alertType={`${
          isSuccess || showAlert ? "success" : isError ? "error" : ""
        }`}
      >
        {isSuccess || showAlert ? (
