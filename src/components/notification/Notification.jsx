          ...
          <div className="2xl:w-4/12 bg-gray-50 h-screen overflow-y-auto p-8 fixed right-0 top-0 shadow-3xl">
            ...
            <div className="w-full p-3 mt-8 bg-white rounded flex">
              ...
              <div className="pl-3">
                <p
                  tabIndex={0}
                  className="focus:outline-none text-lg leading-none"
                >
                  <span className="text-gray-700">James Doe</span> favourited
                  an <span className="text-gray-700">item</span>
                </p>
                <p
                  tabIndex={0}
                  className="focus:outline-none text-sm leading-3 pt-1 text-gray-500"
                >
                  2 hours ago
                </p>
              </div>
              ...
              <div className="pl-3 w-full">
                <div className="flex items-center justify-between w-full">
                  <p
                    ...
                    className="focus:outline-none text-lg leading-none"
                  >
                    <span className="text-gray-700">Sash</span> added you to
                    the group:{" "}
                    <span className="text-gray-700">UX Designers</span>
                  </p>
                  <div
                    tabIndex={0}
            ...
            <div className="w-full p-3 mt-4 bg-white rounded flex">
              ...
              <div className="pl-3">
                <p
                  ...
                  className="focus:outline-none text-lg leading-none"
                >
                  <span className="text-gray-700">Sarah</span> posted in the
                  thread:{" "}
                  <span className="text-gray-700">Update gone wrong</span>
                </p>
                <p
                  tabIndex={0}
                  className="focus:outline-none text-sm leading-3 pt-1 text-gray-500"
            ...
            <div className="w-full p-3 mt-4 bg-red-100 rounded flex items-center">
              ...
              <div className="pl-3 w-full flex items-center justify-between">
                <p
                  tabIndex={0}
                  className="focus:outline-none text-lg leading-none text-red-700"
                >
                  Low on storage: 2.5/32gb remaining
                </p>
                <p
                  tabIndex={0}
                  className="focus:outline-none text-sm leading-3 cursor-pointer underline text-right text-red-700"
                >
                  Manage
                </p>
              </div>
            ...
            <div className="w-full p-3 mt-4 bg-white rounded flex">
              ...
              <div className="pl-3">
                ...
                >
                  ...
                  <span className="text-gray-700"> #25551</span>
                </p>
                <p
                  tabIndex={0}
                  className="focus:outline-none text-sm leading-3 pt-1 text-gray-500"
            ...
            <div className="w-full p-3 mt-8 bg-green-100 rounded flex items-center">
              ...
              <div className="pl-3 w-full">
                <div className="flex items-center justify-between">
                  <p
                    tabIndex={0}
                    className="focus:outline-none text-lg leading-none text-green-700"
                  >
                    Design sprint completed
                  </p>
                  <p
                    tabIndex={0}
                    className="focus:outline-none focus:text-gray-600 text-sm leading-3 underline cursor-pointer text-green-700"
                  >
                    View
                  </p>
                </div>
            ...
            <div className="flex items-center justiyf-between">
              ...
              <p
                tabIndex={0}
                className="focus:outline-none text-lg flex flex-shrink-0 leading-normal px-3 py-16 text-gray-500"
              >
                Thats it for now :)
              </p>
              <hr className="w-full" />
